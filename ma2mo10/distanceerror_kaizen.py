...
station_dict = {"東京":0.00, "品川":6.78, "新横浜":25.54, "名古屋":342.02, "京都":476.31, "新大阪":515.35}
...
try:
    ...
    if station_dict[dep_sta] > station_dict[arr_sta]:
        distance = station_dict[dep_sta] - station_dict[arr_sta]
    else:
        distance = station_dict[arr_sta] - station_dict[dep_sta]
